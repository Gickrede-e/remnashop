      ...
      <div className="container flex h-20 items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 md:hidden">
          ...
          <details className="group relative">
            ...
            <div className="absolute right-0 top-[calc(100%+0.75rem)] z-50 w-[min(88vw,320px)] rounded-[24px] border border-white/10 bg-[hsl(222_34%_5%/0.98)] p-3 shadow-[0_24px_80px_rgba(0,0,0,0.45)]">
