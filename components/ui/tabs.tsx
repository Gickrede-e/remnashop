...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      "inline-flex min-w-[120px] items-center justify-center rounded-xl px-3 py-2 text-sm transition data-[state=active]:bg-white/10 data-[state=active]:text-foreground",
      className
    )}
    {...props}
  />
