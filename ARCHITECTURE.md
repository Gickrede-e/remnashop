...
_Generated by `scripts/build_architecture_map.py` on 2026-03-19 15:07 UTC. Updated manually on 2026-03-22 00:00 UTC._
...
## Change Notes
- 2026-03-22: Removed obsolete marketing/sidebar/site-chrome components (`components/marketing/*`, `components/*/sidebar-nav.tsx`, `components/layout/site-*.tsx`, `components/layout/logo.tsx`, `components/forms/auth-form.tsx`) after the shift to the shared dashboard/admin shell; `components/shell/app-topbar.tsx` now uses `components/shared/logo.tsx`, and this ledger was updated to reflect the auth-first route structure.
