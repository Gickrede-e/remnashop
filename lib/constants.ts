...
export const marketingFaq = [
  ...
  },
  {
    ...
    answer: "Windows, macOS, Linux, iOS, Android и роутеры. Инструкции для каждой платформы есть в разделе «Настройка»."
  },
  {
...
export const setupGuides = [
  {
    platform: "iOS",
    steps: ["Установите клиент.", "Откройте ссылку для подключения из кабинета.", "Импортируйте конфиг и подключитесь."]
  },
  {
    platform: "Android",
    steps: ["Скачайте клиент.", "Вставьте ссылку для подключения.", "Проверьте список узлов и подключитесь."]
  },
  {
    platform: "Windows",
  ...
  {
    platform: "Linux",
    steps: ["Установите CLI или GUI-клиент.", "Подключите ссылку для доступа.", "Проверьте туннель через терминал."]
  }
] as const;
